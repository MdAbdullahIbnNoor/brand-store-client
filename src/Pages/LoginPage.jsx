...
function LoginPage() {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row w-full max-w-sm mx-auto my-20 h-fit bg-slate-500 rounded-lg shadow-lg lg:max-w-6xl md:mt-10 md:min-h-[85vh]">
            <div className="bg-cover lg:w-1/2" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1616441065241-1347e85090f4?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}></div>
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <a href="#" className="flex items-center justify-center mt-4 text-gray-100 transition-colors duration-300 transform border rounded-lg  hover:bg-gray-50 ">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <a href="#" className="text-xs text-center text-gray-100 uppercase  hover:underline">or login with email</a>
                ...
                <form onSubmit={handleLogin}>
                    <div className="mt-4">
                        <label className="block mb-2 text-sm font-medium text-gray-100 " htmlFor="LoggingEmailAddress">Email Address</label>
                    ...
                    <div className="mt-4">
                        <div className="flex justify-between">
                            <label className="block mb-2 text-sm font-medium text-gray-100 " htmlFor="loggingPassword">Password</label>
                ...
                <div className="flex items-center justify-between mt-16">
                    ...
                    <Link to="/signup" className="text-lg text-gray-100 uppercase  hover:underline">or sign up</Link>
