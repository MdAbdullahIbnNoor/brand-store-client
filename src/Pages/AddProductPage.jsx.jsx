...
const AddProductPage = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-screen-lg mx-auto p-4 bg-[#EEEEEE] rounded-lg shadow-md flex flex-col lg:flex-row space-y-4 lg:space-y-0 justify-center items-center lg:justify-between gap-10">
